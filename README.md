...
This repository contains the complete experimental code used in our study on DeepSeek-V3.1’s decision-making behavior in repeated games, with a focus on micro-level action trajectories and reasoning processes in the Iterated Prisoner’s Dilemma (IPD).
...
All experimental scripts follow the naming scheme:

```

single_<noise>*<memory>*<prompt>.py
...
- Noise injection  
- Classic opponent strategies (ALLD, ALLC, TFT, GTFT, CTFT, WSLS, Extortion, HardMajority, SoftMajority, CURE)  
