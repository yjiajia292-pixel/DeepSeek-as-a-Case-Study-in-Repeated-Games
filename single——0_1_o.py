...
# ==== 文件路径 ====
DETAILED_CSV = f"detailed_results_error_{ERROR_RATE:.2f}_1_oC.csv"  # 详细结果文件（合作率/收益）
SUMMARY_CSV = f"summary_results_error_{ERROR_RATE:.2f}_1_oC.csv"    # 汇总结果文件
...
if __name__ == "__main__":
    ...
    # opponent_strategies = ['Extortion'] # 可扩展策略列表
